...
export default function PowerManagement() {
  ...
  const supplylistrik =
    LVMDP1 + LVMDP2 + SolarPanel16 + SolarPanel712 + SDPGenset;
  ...
  const fetchSec = async () => {
    ...
    try {
      ...
      if (Array.isArray(response2.data) && response2.data.length > 0) {
        ...
        console.error(
          "Data response2 tidak ditemukan atau kosong atau bukan array"
        );
      }
  ...
  const options8 = {
    sankey: {
      node: {
        nodePadding: 20,
        label: { fontSize: 16, fontColor: isDarkMode ? "white" : "black" },
      },
    ...
    <div className="bg-cobabg">
      ...
      >
        ...
        <div className="mt-3">
          <div className="ml-16 text-text">
            Total = {totalDaily.toLocaleString()} Kwh
          </div>
          <div className="ml-16 text-text">
      ...
      <div align="center">
        <h1 style={{ fontSize: "2rem" }}>
          <b className="text-text">Power Sankey Diagram </b>
        </h1>
      </div>
      <div align="center">
        <h3 style={{ fontSize: "1rem" }}>
          <b className="text-text">kWh</b>
        </h3>
      </div>
      ...
      <div align="center">
        <h1 style={{ fontSize: "2rem" }}>
          <b>Power Sankey Diagram (%)</b>
        </h1>
      </div>
      <div align="center">
        <h3 style={{ fontSize: "1rem" }}>
          <b>Total Supply Listrik : {supplylistrik} Kwh</b>
        </h3>
      </div>
      <div align="center" className="flex flex-row justify-center mx-12 pb-10">
        <Chart
